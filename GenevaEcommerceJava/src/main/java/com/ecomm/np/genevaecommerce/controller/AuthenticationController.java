...
//    private final AuthService AuthFacade;
//
//    @Autowired
//    public AuthenticationController(AuthService AuthFacade) {
...
//    public ResponseEntity<?> registerNewPassword(@Valid @RequestBody PasswordDTO passwordDTO,
...
//        }
//        try {
//            String message = AuthFacade.registerNewPassword(passwordDTO, userDetails.getEmail());
