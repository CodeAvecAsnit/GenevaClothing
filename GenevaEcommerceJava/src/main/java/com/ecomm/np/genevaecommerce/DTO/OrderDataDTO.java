...
;
   ...
   public OrderDataDTO(String deliveryAddress, String city, String province, String phoneNumber, int orderId, String orderDate, BigDecimal totalPrice, BigDecimal paidPrice, int noOfItems, List<DisplayItemsDTO> imageDisplayList, boolean isActive, boolean isProcessed) {
   ...
   public static OrderDataDTO buildFromOrderItems(OrderedItems items){
